...
console.log(`Whether a customer has placed an order: ${placedOrder}`);
let notplacedOrder: boolean = false;
console.log(`Whether a customer has placed an order: ${notplacedOrder}`);
...
let coordinates: string = "37.7749, -122.4194";
console.log(`Coordinates of a location (latitude, longitude): ${coordinates}`);

//7. Person's marital status: true or false

let marriedPerson: boolean = true;
console.log(`Person's marital status: ${marriedPerson}`);

let unmarriedPerson: boolean = false;
console.log(`Person's marital status: ${unmarriedPerson}`);
...
let placeOfBirth: string = "New York City";
console.log(`Person's birthplace: ${placeOfBirth}`);
